...
<div className="text-lg sm:text-2xl text-white mb-8 opacity-90">
  Keep Your <span className="underline decoration-[#00bcd4]">Sales</span>, <span className="underline decoration-[#00bcd4]">Placement</span>, and Travel Activities Organized with a Single Tap.
        ...
        <Link
          to="/home"
          className="flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 bg-transparent border-4 border-[#00bcd4] text-[#00bcd4] rounded-full text-2xl font-bold hover:scale-110 transform transition-all duration-300 ease-in-out shadow-lg focus:ring-4 focus:ring-[#00bcd4] focus:ring-opacity-50"
        >
          <span className="text-[#00bcd4] text-2xl">&#8594;</span> {/* Right-pointing arrow */}
        </Link>
      </div>
    </div>
  );
